...
<html lang="ru">
  ...
  <div class="registrationTop">
      <p>Вы авторизовались как <?php  echo $_SESSION['email'] . ' (' . $_SESSION['regName'] .')';?>
          <a class="myOrders" href="admin.php"> Админка </a> | <a class="myOrders" href="clearsession.php">Выйти</a></p>
  </div>
  <?php }?>
    <div class="wrapper">
      <div class="maincontent">
        <section class="section hero">
          <div class="container">
            <header class="header">
              ...
              <div class="header__links"><a class="order-link btn" href="/#makeOrderTopButton">Заказать</a><a class="hamburger-menu-link" href="">
        ...
        <section class="section best">
          ...
          <a name="makeOrderTopButton"></a>
        <?php include('sliderGoods.php');?>
        ...
        <section class="section order">
          <div class="container">
            ...
            <div class="order__form">
              <form action="registration.php" method="post" enctype="multipart/form-data" class="order__form-tag" id="order-form">
                <div class="order__form-col">
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      ...
                      <input class="order__form-input" required name="name" type="text" placeholder="">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Телефон</div>
                      <input class="order__form-input phone-mask" required name="phone" type="text" placeholder="">
                    </label>
                  </div>
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      <div class="order__form-label">email</div>
                      <input class="order__form-input" required name="email" type="email" placeholder="">
                    </label>
                    <label class="order__form-block">
                  ...
                  <div class="order__form-row order__form-row_quatro">
                    <label class="order__form-block">
                      ...
                      <input class="order__form-input" required name="home" type="text" placeholder="">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Корпус</div>
                      <input class="order__form-input" required name="part" type="text" placeholder="">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Квартира</div>
                      <input class="order__form-input" required name="appt" type="text" placeholder="">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Этаж</div>
                      <input class="order__form-input" required name="floor" type="text" placeholder="">
                    </label>
                  </div>
                </div>
                <div class="order__form-col">
                  ...
                  <div class="order__form-buttons">
                    <div class="order__form-row">
                      <label class="order__radio">
                        <input class="order__radio-elem" name="shortchange" type="radio">
                        <div class="order__radio-fake"></div>
                        <div class="order__radio-title">Потребуется сдача</div>
                      </label>
                      <label class="order__radio">
                        <input class="order__radio-elem" name="cardpay" type="radio">
                        <div class="order__radio-fake"></div>
